...
import { ContactShadows, Float, Environment as Environment } from "@react-three/drei";
...
export default function Shapes(){
    return (
        <div className="row-span-1 row-start-1 -mt-9 aspect-square md:col-span-1 md:col-start-2 md:nt-0"> 
...
function Geometries() {
    ...
    const materials = [ new THREE.MeshNormalMaterial(), 
        ...
        new THREE.MeshStandardMaterial({ color: 0xeb3b5a, roughness: 0.1 }),
